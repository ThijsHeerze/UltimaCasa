        ...
        <div class="col-sm-5 col-md-7 col-lg-5 col-sm-offset-4 col-md-offset-3 col-lg-offset-4">
            ...
            <form action="rolins.php" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" min="0" max="127" id="Waarde" name="Waarde" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" class="action-button" id="RID" name="RID" value="' . $relatieid . '" title="Rol toevoegen.">Toevoegen</button>
