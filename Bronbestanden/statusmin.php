...
if ($ID !== null && $relatieid !== null) {
    $sql = "SELECT StatusCode, Status FROM statussen WHERE ID = " . $ID;
        ...
        <div class="container">
            <div class="col-sm-5 col-md-7 col-lg-5 col-sm-offset-4 col-md-offset-3 col-lg-offset-4" id="details">
                ...
                <form action="statusdel.php" method="GET">
                    <div class="form-group">
                        <button type="submit" class="action-button" id="wis" name="wis" value="' . $ID . '" title="Deze status verwijderen.">Status verwijderen
                        </button>
