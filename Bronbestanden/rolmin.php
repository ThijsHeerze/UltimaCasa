...
$sql = "SELECT Naam, Omschrijving, Waarde, Landingspagina FROM rollen WHERE ID = :ID";
$stmt = $db->prepare($sql);
    ...
    <div class="container">
        <div class="col-sm-5 col-md-7 col-lg-5 col-sm-offset-4 col-md-offset-3 col-lg-offset-4" id="details">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="' . $gegevens["Landingspagina"] . '" id="Landingspagina" name="Landingspagina" readonly>
            </div>
            <form action="roldel.php" method="GET">
                <div class="form-group">
                    <button type="submit" class="action-button" id="wis" name="wis" value="' . $ID . '" title="Deze rol verwijderen.">Rol verwijderen</button>
